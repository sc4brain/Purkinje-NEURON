...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaF /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/NaF.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
  ...
  _ltemp_adj_m = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   ...
   _lk_alpha_m = 0.1 ;
   _ld_alpha_m = - 5.0 ;
   _lalpha = _lA_alpha_m * exp ( ( _lv - _ld_alpha_m ) * _lk_alpha_m ) ;
   _lA_beta_m = 7.0 ;
   _lk_beta_m = - 0.05 ;
   _ld_beta_m = - 65.0 ;
   ...
   _lA_beta_h = 7.5 ;
   _lk_beta_h = 0.0555556 ;
   _ld_beta_h = 3.0 ;
   _lbeta = _lA_beta_h * exp ( ( _lv - _ld_beta_h ) * _lk_beta_h ) ;

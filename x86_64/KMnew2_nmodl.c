...
#define nrn_init _nrn_init__KMnew2_nmodl
#define _nrn_initial _nrn_initial__KMnew2_nmodl
#define nrn_cur _nrn_cur__KMnew2_nmodl
#define _nrn_current _nrn_current__KMnew2_nmodl
#define nrn_jacob _nrn_jacob__KMnew2_nmodl
#define nrn_state _nrn_state__KMnew2_nmodl
#define _net_receive _net_receive__KMnew2_nmodl 
#define _f_rates _f_rates__KMnew2_nmodl 
#define rates rates__KMnew2_nmodl 
#define states states__KMnew2_nmodl 
...
extern Memb_func* memb_func;
 ...
 "setdata_KMnew2_nmodl", _hoc_setdata,
 "rates_KMnew2_nmodl", _hoc_rates,
 "states_KMnew2_nmodl", _hoc_states,
 0, 0
};
...
#define ek ek_KMnew2_nmodl
 double ek = -85;
#define usetable usetable_KMnew2_nmodl
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_KMnew2_nmodl", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ek_KMnew2_nmodl", "mV",
 "gmax_KMnew2_nmodl", "mho/cm2",
 "ik_KMnew2_nmodl", "mA/cm2",
 0,0
};
 ...
 "ek_KMnew2_nmodl", &ek_KMnew2_nmodl,
 "usetable_KMnew2_nmodl", &usetable_KMnew2_nmodl,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "k_ion");
 	...
 	ivoc_help("help ?1 KMnew2_nmodl /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/KMnew2_nmodl.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   _lsum = ( 3.3 * exp ( ( _lv + 35.0 ) / 20.0 ) + exp ( - ( _lv + 35.0 ) / 20.0 ) ) / 200.0 ;
...
static int _ode_count(int _type){ hoc_execerror("KMnew2_nmodl", "cannot be used with CVODE"); return 0;}

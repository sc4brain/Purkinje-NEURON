...
#define nrn_init _nrn_init__Kh2
#define _nrn_initial _nrn_initial__Kh2
#define nrn_cur _nrn_cur__Kh2
#define _nrn_current _nrn_current__Kh2
#define nrn_jacob _nrn_jacob__Kh2
#define nrn_state _nrn_state__Kh2
#define _net_receive _net_receive__Kh2 
#define _f_rates _f_rates__Kh2 
#define rates rates__Kh2 
#define states states__Kh2 
...
extern Memb_func* memb_func;
 ...
 "setdata_Kh2", _hoc_setdata,
 "rates_Kh2", _hoc_rates,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kh2 /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/Kh2.mod\n");
...
static int _reset;
static char *modelname = "Channel: Kh2";

...
#define nrn_init _nrn_init__Kdr_nmodl
#define _nrn_initial _nrn_initial__Kdr_nmodl
#define nrn_cur _nrn_cur__Kdr_nmodl
#define _nrn_current _nrn_current__Kdr_nmodl
#define nrn_jacob _nrn_jacob__Kdr_nmodl
#define nrn_state _nrn_state__Kdr_nmodl
#define _net_receive _net_receive__Kdr_nmodl 
#define _f_trates _f_trates__Kdr_nmodl 
#define rates rates__Kdr_nmodl 
#define states states__Kdr_nmodl 
#define trates trates__Kdr_nmodl 
...
extern Memb_func* memb_func;
 ...
 "setdata_Kdr_nmodl", _hoc_setdata,
 "rates_Kdr_nmodl", _hoc_rates,
 "states_Kdr_nmodl", _hoc_states,
 "trap0_Kdr_nmodl", _hoc_trap0,
 "trates_Kdr_nmodl", _hoc_trates,
 0, 0
};
#define trap0 trap0_Kdr_nmodl
...
#define ek ek_Kdr_nmodl
 double ek = -85;
#define usetable usetable_Kdr_nmodl
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Kdr_nmodl", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ek_Kdr_nmodl", "mV",
 "gmax_Kdr_nmodl", "mho/cm2",
 "ik_Kdr_nmodl", "mA/cm2",
 0,0
};
 ...
 "ek_Kdr_nmodl", &ek_Kdr_nmodl,
 "usetable_Kdr_nmodl", &usetable_Kdr_nmodl,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "k_ion");
 	...
 	ivoc_help("help ?1 Kdr_nmodl /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/Kdr_nmodl.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lvm ) {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   _lalpha = trap0 ( _threadargscomma_ _lvm , 8.0 , 23.5e-3 , 12.0 ) ;
   _lbeta = 5.0 * exp ( ( _lvm + 127.0 ) / ( - 30.0 ) ) ;
   minf = _lalpha / ( _lalpha + _lbeta ) ;
   _lgamma = trap0 ( _threadargscomma_ _lvm , - 12.0 , 23.5e-3 , 12.0 ) ;
   _lzeta = 5.0 * exp ( ( _lvm + 147.0 ) / ( - 30.0 ) ) ;
   _ltaum = 1.0 / ( _lgamma + _lzeta ) ;
   mexp = 1.0 - exp ( _ltinc / _ltaum ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lvm + 25.0 ) / 4.0 ) ) ;
   if ( _lvm < - 25.0 ) {
     _ltauh = 1200.0 ;
     }
   else {
...
double trap0 ( _threadargsprotocomma_ double _lvn , double _lth , double _la , double _lq ) {
   double _ltrap0;
 if ( fabs ( _lvn - _lth ) > 1e-6 ) {
     _ltrap0 = _la * ( _lvn - _lth ) / ( 1.0 - exp ( - ( _lvn - _lth ) / _lq ) ) ;
     }
   else {
     _ltrap0 = _la * _lq ;
     }
...
static int _ode_count(int _type){ hoc_execerror("Kdr_nmodl", "cannot be used with CVODE"); return 0;}

...
#define nrn_init _nrn_init__KA_nmodl
#define _nrn_initial _nrn_initial__KA_nmodl
#define nrn_cur _nrn_cur__KA_nmodl
#define _nrn_current _nrn_current__KA_nmodl
#define nrn_jacob _nrn_jacob__KA_nmodl
#define nrn_state _nrn_state__KA_nmodl
#define _net_receive _net_receive__KA_nmodl 
#define _f_rates _f_rates__KA_nmodl 
#define rates rates__KA_nmodl 
#define states states__KA_nmodl 
...
extern Memb_func* memb_func;
 ...
 "setdata_KA_nmodl", _hoc_setdata,
 "rates_KA_nmodl", _hoc_rates,
 "states_KA_nmodl", _hoc_states,
 0, 0
};
...
#define usetable usetable_KA_nmodl
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_KA_nmodl", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_KA_nmodl", "mho/cm2",
 "ik_KA_nmodl", "mA/cm2",
 0,0
};
 ...
 "usetable_KA_nmodl", &usetable_KA_nmodl,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 KA_nmodl /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/KA_nmodl.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("KA_nmodl", "cannot be used with CVODE"); return 0;}

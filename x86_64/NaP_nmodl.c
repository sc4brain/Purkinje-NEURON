...
#define nrn_init _nrn_init__NaP_nmodl
#define _nrn_initial _nrn_initial__NaP_nmodl
#define nrn_cur _nrn_cur__NaP_nmodl
#define _nrn_current _nrn_current__NaP_nmodl
#define nrn_jacob _nrn_jacob__NaP_nmodl
#define nrn_state _nrn_state__NaP_nmodl
#define _net_receive _net_receive__NaP_nmodl 
#define _f_rates _f_rates__NaP_nmodl 
#define rates rates__NaP_nmodl 
#define states states__NaP_nmodl 
...
extern Memb_func* memb_func;
 ...
 "setdata_NaP_nmodl", _hoc_setdata,
 "rates_NaP_nmodl", _hoc_rates,
 "states_NaP_nmodl", _hoc_states,
 0, 0
};
...
#define usetable usetable_NaP_nmodl
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_NaP_nmodl", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_NaP_nmodl", "mho/cm2",
 "ina_NaP_nmodl", "mA/cm2",
 0,0
};
 ...
 "usetable_NaP_nmodl", &usetable_NaP_nmodl,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 NaP_nmodl /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/NaP_nmodl.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("NaP_nmodl", "cannot be used with CVODE"); return 0;}

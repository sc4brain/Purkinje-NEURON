...
#define nrn_init _nrn_init__K2_nmodl
#define _nrn_initial _nrn_initial__K2_nmodl
#define nrn_cur _nrn_cur__K2_nmodl
#define _nrn_current _nrn_current__K2_nmodl
#define nrn_jacob _nrn_jacob__K2_nmodl
#define nrn_state _nrn_state__K2_nmodl
#define _net_receive _net_receive__K2_nmodl 
#define _f_rate _f_rate__K2_nmodl 
#define rate rate__K2_nmodl 
#define ratezinf ratezinf__K2_nmodl 
#define state state__K2_nmodl 
...
extern Memb_func* memb_func;
 ...
 "setdata_K2_nmodl", _hoc_setdata,
 "alp_K2_nmodl", _hoc_alp,
 "bet_K2_nmodl", _hoc_bet,
 "rate_K2_nmodl", _hoc_rate,
 "ratezinf_K2_nmodl", _hoc_ratezinf,
 "state_K2_nmodl", _hoc_state,
 0, 0
};
#define alp alp_K2_nmodl
#define bet bet_K2_nmodl
 extern double alp( double , double );
 extern double bet( double );
 /* declare global and static user variables */
#define ek ek_K2_nmodl
 double ek = -85;
#define usetable usetable_K2_nmodl
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_K2_nmodl", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ek_K2_nmodl", "mV",
 "gmax_K2_nmodl", "mho/cm2",
 "ik_K2_nmodl", "mA/cm2",
 0,0
};
 ...
 "ek_K2_nmodl", &ek_K2_nmodl,
 "usetable_K2_nmodl", &usetable_K2_nmodl,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 K2_nmodl /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/K2_nmodl.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("K2_nmodl", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 65 in file K2_nmodl.mod:\n    SOLVE state\n"); nrn_complain(_p); abort_run(error);}
 } }}

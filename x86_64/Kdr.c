...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kdr /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/Kdr.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _ltemp_adj_m , _lA_alpha_m , _lk_alpha_m , _ld_alpha_m , _lA_beta_m , _lk_beta_m , _ld_beta_m , _lA_gamma_m , _lk_gamma_m , _ld_gamma_m , _lA_zeta_m , _lk_zeta_m , _ld_zeta_m , _lA_tau_m , _lk_tau_m , _ld_tau_m , _ltemp_adj_h , _lA_tau_h , _lk_tau_h , _ld_tau_h , _lA_inf_h , _lk_inf_h , _ld_inf_h ;
  _ltemp_adj_m = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltemp_adj_h = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _lA_alpha_m = 0.282 ;
   _lk_alpha_m = 0.08333333 ;
   _ld_alpha_m = 8.0 ;
   _lalpha = _lA_alpha_m * vtrap ( _threadargscomma_ ( _lv - _ld_alpha_m ) , ( 1.0 / _lk_alpha_m ) ) ;
   _lA_beta_m = 5.0 ;
   _lk_beta_m = - 0.0333333 ;
   _ld_beta_m = - 127.0 ;
   _lbeta = _lA_beta_m * exp ( ( _lv - _ld_beta_m ) * _lk_beta_m ) ;
   _lA_gamma_m = 0.282 ;
   _lk_gamma_m = 0.08333333 ;
   _ld_gamma_m = - 12.0 ;
   _lgamma = _lA_gamma_m * vtrap ( _threadargscomma_ ( _lv - _ld_gamma_m ) , ( 1.0 / _lk_gamma_m ) ) ;
   _lA_zeta_m = 5.0 ;
   _lk_zeta_m = - 0.0333333 ;
   _ld_zeta_m = - 147.0 ;
   _lzeta = _lA_zeta_m * exp ( ( _lv - _ld_zeta_m ) * _lk_zeta_m ) ;
   _ltau = 1.0 / ( _lgamma + _lzeta ) ;
   ...
   _lk_inf_h = 0.25 ;
   _ld_inf_h = - 25.0 ;
   _linf = _lA_inf_h / ( exp ( ( _lv - _ld_inf_h ) * _lk_inf_h ) + 1.0 ) ;
   hinf = _linf ;
    return 0; }
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gion = gmax * ( pow( ( 1.0 * m ) , 2.0 ) ) * ( pow( ( 1.0 * h ) , 1.0 ) ) ;
   ik = gion * ( v - ek ) ;
   }
 _current += ik;

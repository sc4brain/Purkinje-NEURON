...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaP /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/NaP.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _ltemp_adj_m , _lA_alpha_m , _lk_alpha_m , _ld_alpha_m , _lA_beta_m , _lk_beta_m , _ld_beta_m ;

...
#define nrn_init _nrn_init__cad_nmodl_altered
#define _nrn_initial _nrn_initial__cad_nmodl_altered
#define nrn_cur _nrn_cur__cad_nmodl_altered
#define _nrn_current _nrn_current__cad_nmodl_altered
#define nrn_jacob _nrn_jacob__cad_nmodl_altered
#define nrn_state _nrn_state__cad_nmodl_altered
#define _net_receive _net_receive__cad_nmodl_altered 
#define state state__cad_nmodl_altered 
...
extern Memb_func* memb_func;
 ...
 "setdata_cad_nmodl_altered", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define cainf cainf_cad_nmodl_altered
 double cainf = 4e-05;
#define taur taur_cad_nmodl_altered
 double taur = 0.1;
 ...
 "taur_cad_nmodl_altered", "ms",
 "cainf_cad_nmodl_altered", "mM",
 "depth_cad_nmodl_altered", "um",
 0,0
};
 ...
 "taur_cad_nmodl_altered", &taur_cad_nmodl_altered,
 "cainf_cad_nmodl_altered", &cainf_cad_nmodl_altered,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cad_nmodl_altered /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/cad_nmodl_altered.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   drive_channel = - ( 10000.0 ) * ica / ( 2.0 * 96494.0 * depth ) ;
   if ( drive_channel <= 0. ) {
     drive_channel = 0. ;
     }

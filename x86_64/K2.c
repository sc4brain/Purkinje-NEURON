...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 K2 /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/K2.mod\n");
...
static int  settables ( _threadargsprotocomma_ double _lv , double _lcai ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _lca_conc_m , _lca_conc_z , _ltemp_adj_m , _lA_alpha_m , _lk_alpha_m , _ld_alpha_m , _lA_beta_m , _lk_beta_m , _ld_beta_m , _ltemp_adj_z , _lA_alpha_z , _lk_alpha_z , _ld_alpha_z , _lA_beta_z , _lk_beta_z , _ld_beta_z , _lA_tau_z , _lk_tau_z , _ld_tau_z , _lA_inf_z , _lk_inf_z , _ld_inf_z ;
  _ltemp_adj_m = 1.0 ;
   _ltemp_adj_z = 1.0 ;
   _lca_conc_m = _lcai ;
   _lca_conc_m = _lca_conc_m / 1000000.0 ;
   _lalpha = 25.0 ;
   _lca_conc_m = _lca_conc_m * 1000000.0 ;
   _lA_beta_m = 0.075 ;
   _lk_beta_m = - 0.1666666667 ;
   _ld_beta_m = - 25.0 ;
   _lbeta = _lA_beta_m * exp ( ( _lv - _ld_beta_m ) * _lk_beta_m ) ;
   mtau = 1.0 / ( _ltemp_adj_m * ( _lalpha + _lbeta ) ) ;
   minf = _lalpha / ( _lalpha + _lbeta ) ;
   _lca_conc_z = _lcai ;
   _lca_conc_z = _lca_conc_z / 1000000.0 ;
   _lalpha = 0.2 / ( ( _lca_conc_z * 1e6 ) * 1000.0 ) ;
   _lca_conc_z = _lca_conc_z * 1000000.0 ;
   _lca_conc_z = _lca_conc_z / 1000000.0 ;
   _lbeta = 1.0 ;
   _lca_conc_z = _lca_conc_z * 1000000.0 ;
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gion = gmax * ( pow( ( 1.0 * m ) , 1.0 ) ) * ( pow( ( 1.0 * z ) , 2.0 ) ) ;
   ik = gion * ( v - ek ) ;
   }
 _current += ik;

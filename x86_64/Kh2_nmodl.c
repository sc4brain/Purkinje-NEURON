...
#define nrn_init _nrn_init__Kh2_nmodl
#define _nrn_initial _nrn_initial__Kh2_nmodl
#define nrn_cur _nrn_cur__Kh2_nmodl
#define _nrn_current _nrn_current__Kh2_nmodl
#define nrn_jacob _nrn_jacob__Kh2_nmodl
#define nrn_state _nrn_state__Kh2_nmodl
#define _net_receive _net_receive__Kh2_nmodl 
#define _f_rates _f_rates__Kh2_nmodl 
#define rates rates__Kh2_nmodl 
#define states states__Kh2_nmodl 
...
extern Memb_func* memb_func;
 ...
 "setdata_Kh2_nmodl", _hoc_setdata,
 "rates_Kh2_nmodl", _hoc_rates,
 "states_Kh2_nmodl", _hoc_states,
 0, 0
};
...
#define usetable usetable_Kh2_nmodl
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Kh2_nmodl", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Kh2_nmodl", "mho/cm2",
 "ik_Kh2_nmodl", "mA/cm2",
 0,0
};
 ...
 "usetable_Kh2_nmodl", &usetable_Kh2_nmodl,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 Kh2_nmodl /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/Kh2_nmodl.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   minf = 0.2 / ( 1.0 + exp ( ( _lv + 82.0 ) / 7.0 ) ) ;
   nexp = 1.0 - exp ( _ltinc / 36.8 ) ;
    return 0; }
...
static int _ode_count(int _type){ hoc_execerror("Kh2_nmodl", "cannot be used with CVODE"); return 0;}

...
#define nrn_init _nrn_init__Kh1
#define _nrn_initial _nrn_initial__Kh1
#define nrn_cur _nrn_cur__Kh1
#define _nrn_current _nrn_current__Kh1
#define nrn_jacob _nrn_jacob__Kh1
#define nrn_state _nrn_state__Kh1
#define _net_receive _net_receive__Kh1 
#define _f_rates _f_rates__Kh1 
#define rates rates__Kh1 
#define states states__Kh1 
...
extern Memb_func* memb_func;
 ...
 "setdata_Kh1", _hoc_setdata,
 "rates_Kh1", _hoc_rates,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kh1 /Users/hashmup/nC_projects/PurkinjeCell.ncx/generatedNEURON/x86_64/Kh1.mod\n");
...
static int _reset;
static char *modelname = "Channel: Kh1";
